...
namespace Analysis
{
    class Program
    {
        ...
        {
            using (StreamWriter w = new StreamWriter(@"C:\Users\Administrator\Desktop\orange-1.tab", /*append=*/false, Encoding.ASCII))
            {
                ...
                Orange.SaveOrangeTab(featureNames,
                    dataset, @"C:\Users\Administrator\Desktop\orange.tab");
                Weka.SaveWekaArff(featureNames,
                    dataset, @"C:\Users\Administrator\Desktop\weka.arff");
